...
<title>ATM System-Widrawal</title>
</head>
...
<div id="atmheader_wrapper">
	<div id="atmheader">
    	...
    	<!-- end of site_title -->
<div id="header_right">
	Login&nbsp;<a href="Login.html"><img src="shadow/next.png" /></a>
    Registration&nbsp;<a href="registration.html" id="header_right_img"><img src="shadow/next.png" /></a>
...
<caption><b>Widrawal</b></caption>
<tr>
<td>
<label for="acnt_type">Account Type:</label> 
</td>
<td><select><option selected="selected">Savings</option><option>Current</option></select>
</td>
</tr>
...
<td><input type="number" required="required"/></td>
		...
		<div class="cleaner_h10"></div>		
<tr>
<td colspan="2"><center><input type="submit" value="Yes" id="atm_reg_btn"/</center></td>
<td></td>
</tr>                 
</table>              
</form>
