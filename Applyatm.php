...
<title>ATM System-Apply ATM</title>
</head>
...
<caption align="left"><b>Application For ATM Card</b></caption>
<tr>
<td>
<label for="First Name"> First Name:</label> 
</td>
<td><input type="text" value="Enter First Name" onFocus="if(this.value='Enter First Nmae')this.value=''" required="required" />
</td>
</tr>
				<div class="cleaner_h10"></div>
<tr>
<td><label for="Middle name">Middle Name:</label></td>
<td><input type="text" value="Enter Middle Name" onFocus="if(this.value='Enter Middle Nmae')this.value=''" required="required" /></td>
</tr>
				<div class="cleaner_h10"></div> 
<tr>
<td> <label for="Last Name">Last Name:</label></td>
<td><input type="text" value="Enter Last Name" onFocus="if(this.value='Enter Last Nmae')this.value=''" required="required" /></td>
</tr>              
         		<div class="cleaner_h10"></div>
<tr>
...
<td> <input type="date" id="author" required="required"/></td>
</tr>               
				<div class="cleaner_h10"></div>
<tr>
<td><label for="upload_photo">Photo:</label></td>
<td><input type="file" id="author" required="required"/></td>
</tr> 
		<div class="cleaner_h10"></div>
<tr>
<td><label for="Adhar No">Adhar Card No.:</label></td>
<td><input type="number" required="required" /></td>
</tr> 
		<div class="cleaner_h10"></div>
<tr>
<td><label for="pan_no">PAN No.:</label></td>
<td><input type="number" required="required"/></td>
</tr> 
				<div class="cleaner_h10"></div>		
<tr>
...
<td><input type="text" name="email" id="email" required="required" /></td>
				...
				<div class="cleaner_h10"></div>
<tr>
<td colspan="2"><center><input type="submit" value="Apply" id="atm_reg_btn"/</center></td>
<td></td>
</tr>                 
</table>              
</form>
